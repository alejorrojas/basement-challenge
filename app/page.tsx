...
export default async function Home() {
  ...
  return (
     <main className="h-full flex flex-col items-center xs:gap-5 md:gap-20 bg-black">
      ...
      <Image className='xs:invisible lg:visible absolute lg:left-28 lg:w-20 lg:top-[52%] xl:top-[65%] xl:w-40 2xl:w-48 2xl:top-[70%] animate-spin-slow' src="/asterisk.svg" width={150} height={150} alt=''/>
      <Image className='xs:invisible lg:visible absolute lg:right-20 lg:w-20 lg:top-[40%]  xl:top-[50%] xl:w-40 2xl:w-48 2xl:top-[58%] animate-spin-slow-alt' src="/asterisk.svg" width={150} height={150} alt=''/>
