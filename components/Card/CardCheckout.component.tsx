        ...
        <footer className='relative flex justify-between'>
            <div className='flex flex-col gap-4'>
              <div className='flex xs:gap-4 gap-8 items-center'>
                ...
                <div className='m-0 xs:w-16 xs:px-2  2xl:py-2  xl:px-5  md:w-24 flex justify-between xs:max-md:text-xs  md:text-lg xs:border-2 border-[3px] rounded-[2rem] border-solid border-white cursor-pointer'>
              ...
              <div className='flex gap-1 2xl:gap-6 items-center'>
                <div className='flex items-center gap-3'>
                  ...
                  {options[0].values.map(value =>(
                    <button  onClick={()=>updateSize(value)} className={`${value === checkoutProduct.checkoutSize ? "border-white border-2  rounded-full " : "border-black border-2   rounded-full "} xs:max-md:border-[1px] xs:px-1 xl:px-3 xl:py-1 2xl:px-3 2xl:py-1 xs:max-md:text-sm  text-base`} key={value}>
                      {value}
                    </button>
                  )) }
                </div>
