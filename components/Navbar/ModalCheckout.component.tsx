  ...
  return (
    <Dialog.Root>
        ...
        <Dialog.Portal>
            ...
            <Dialog.Content className='flex justify-between flex-col z-50 fixed top-0 right-0 w-[45%] xs:max-md:w-screen xs:max-md:h-screen h-[80%] bg-black border-solid border-t-0 border-r-0 border-white border-2'>
            <div className='p-8 flex flex-col'>
                ...
                <ScrollArea className='max-h-10' scrollbars="vertical" type="always">
